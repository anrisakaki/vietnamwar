...
dn_indfe_n <- (list(
  feols(tot_workerratio ~ log(tot_bmr) + sex_ratio + log(popdensity_02) | nganh_kd + lhdn,
        subset(dn02, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sex_ratio + log(popdensity_03) | nganh_kd + lhdn,
        subset(dn03, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio05 + log(popdensity_04) | nganh_kd + lhdn,
        subset(dn04, south == 0),
        vcov = ~tinh+huyen), 
  feols(tot_workerratio ~ log(tot_bmr) + sexratio05 + log(popdensity_05) | nganh_kd + lhdn,
        subset(dn05, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio05 + log(popdensity_06) | nganh_kd + lhdn,
        subset(dn06, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio07 + log(popdensity_07) | nganh_kd + lhdn,
        subset(dn07, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio08 + log(popdensity_08)  | nganh_kd + lhdn,
        subset(dn08, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio09 + log(popdensity_09)  | nganh_kd + lhdn,
        subset(dn09, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio10 + log(popdensity_10)  | nganh_kd + lhdn,
        subset(dn10, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio11 + log(popdensity_11)  | nganh_kd + lhdn,
        subset(dn11, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio12 + log(popdensity_12)  | nganh_kd + lhdn,
        subset(dn12, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio13 + log(popdensity_13)  | nganh_kd + lhdn,
        subset(dn13, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio14 + log(popdensity_14)  | nganh_kd + lhdn,
        subset(dn14, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio15 + log(popdensity_15)  | nganh_kd + lhdn,
        subset(dn15, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio16 + log(popdensity_16)  | nganh_kd + lhdn,
        subset(dn16, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio17 + log(popdensity_17)  | nganh_kd + lhdn,
        subset(dn17, south == 0),
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(tot_bmr) + sexratio18 + log(popdensity_18)  | nganh_kd + lhdn,
        subset(dn18, south == 0),
        vcov = ~tinh+huyen)))
...
dn_indfe_cas <- (list(
  feols(tot_workerratio ~ log(killed_tot) + sex_ratio + log(popdensity_02) | nganh_kd + lhdn,
        dn02,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sex_ratio + log(popdensity_03) | nganh_kd + lhdn,
        dn03,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio05 + log(popdensity_04) | nganh_kd + lhdn,
        dn04,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio05 + log(popdensity_05) | nganh_kd + lhdn,
        dn05,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio05 + log(popdensity_06) | nganh_kd + lhdn,
        dn06,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio07 + log(popdensity_07) | nganh_kd + lhdn,
        dn07,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio08 + log(popdensity_08) | nganh_kd + lhdn,
        dn08,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio09 + log(popdensity_09) | nganh_kd + lhdn,
        dn09,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio10 + log(popdensity_10) | nganh_kd + lhdn,
        dn10,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio11 + log(popdensity_11) | nganh_kd + lhdn,
        dn11,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio12 + log(popdensity_12) | nganh_kd + lhdn,
        dn12,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio13 + log(popdensity_13) | nganh_kd + lhdn,
        dn13,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio14 + log(popdensity_14) | nganh_kd + lhdn,
        dn14,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio15 + log(popdensity_15) | nganh_kd + lhdn,
        dn15,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio16 + log(popdensity_16) | nganh_kd + lhdn,
        dn16,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio17 + log(popdensity_17) | nganh_kd + lhdn,
        dn17,
        vcov = ~tinh+huyen),
  feols(tot_workerratio ~ log(killed_tot) + sexratio18 + log(popdensity_18) | nganh_kd + lhdn,
        dn18,
        vcov = ~tinh+huyen)))
...
etable(list(
  feols(female_dir ~ log(tot_bmr) + sexratio16 + log(popdensity_16) + as.factor(dir_ethnicity) + dir_yob | lhdn + nganh_kd,
        subset(dn16, south == 0),
        vcov = ~tinh+huyen),
  feols(female_dir ~ log(tot_bmr) + sexratio16 + log(popdensity_16) + as.factor(dir_ethnicity) + dir_yob | lhdn + nganh_kd,
        subset(dn16, south == 1),
