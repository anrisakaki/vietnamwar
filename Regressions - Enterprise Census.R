...
dn_dist_olscoef_agri_ns <- dn_dist_olscoef_agri_ns %>% filter(term != "(Intercept)")
...
dn_dist_fecoef_agri_s <- lapply(dn_dist_fe_agri_s, tidy)
dn_dist_fecoef_agri_n <- lapply(dn_dist_fe_agri_n, tidy)
dn_dist_fecoef_agri_s <- do.call(rbind, dn_dist_fecoef_agri_s)
dn_dist_fecoef_agri_n <- do.call(rbind, dn_dist_fecoef_agri_n)
dn_dist_fecoef_agri_s$year <- rep(seq(2000, 2018), each = nrow(dn_dist_fecoef_agri_s) / length(seq(2000, 2018)))
dn_dist_fecoef_agri_n$year <- rep(seq(2000, 2018), each = nrow(dn_dist_fecoef_agri_n) / length(seq(2000, 2018)))

dn_dist_fecoef_agri_n$group <- "North"
dn_dist_fecoef_agri_s$group <- "South"
dn_dist_fecoef_agri_ns <- rbind(dn_dist_fecoef_agri_n, dn_dist_fecoef_agri_s)
dn_dist_fecoef_agri_ns <- dn_dist_fecoef_agri_ns %>% filter(term != "(Intercept)")

dn_dist_fe_manu_s <- (list(
  feols(workerratio ~ log(tot_bmr) | prov2018,
        subset(dn_dist_ind, year == 2000 & industry == "Manufacturing" & south == 1),
        vcov = ~dist2018),
  feols(workerratio ~ log(tot_bmr) | prov2018,
...
dn_dist_fecoef_manu_s <- lapply(dn_dist_fe_manu_s, tidy)
dn_dist_fecoef_manu_n <- lapply(dn_dist_fe_manu_n, tidy)
dn_dist_fecoef_manu_s <- do.call(rbind, dn_dist_fecoef_manu_s)
dn_dist_fecoef_manu_n <- do.call(rbind, dn_dist_fecoef_manu_n)
dn_dist_fecoef_manu_s$year <- rep(seq(2000, 2018), each = nrow(dn_dist_fecoef_manu_s) / length(seq(2000, 2018)))
dn_dist_fecoef_manu_n$year <- rep(seq(2000, 2018), each = nrow(dn_dist_fecoef_manu_n) / length(seq(2000, 2018)))

dn_dist_fecoef_manu_n$group <- "North"
dn_dist_fecoef_manu_s$group <- "South"
dn_dist_fecoef_manu_ns <- rbind(dn_dist_fecoef_manu_n, dn_dist_fecoef_manu_s)
dn_dist_fecoef_manu_ns <- dn_dist_fecoef_manu_ns %>% filter(term != "(Intercept)")
