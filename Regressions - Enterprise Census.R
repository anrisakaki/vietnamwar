...
dn_ols_coef_prov <- do.call(rbind, dn_ols_coef_prov) %>% filter(term == "log(tot_bmr_prov)")
...
dn_ols_prov_coef_n <- do.call(rbind, dn_ols_prov_coef_n) %>% filter(term == "log(tot_bmr_prov)")
dn_ols_prov_coef_s <- do.call(rbind, dn_ols_prov_coef_s) %>% filter(term == "log(tot_bmr_prov)")
...
dn_indfe_prov_coef <- do.call(rbind, dn_indfe_prov_coef) %>% filter(term == "log(tot_bmr_prov)")
...
dn_formal_ols_coef_prov <- do.call(rbind, dn_formal_ols_coef_prov) %>% filter(term == "log(tot_bmr_prov)")
...
dn_formal_ols_prov_coef_n <- do.call(rbind, dn_formal_ols_prov_coef_n) %>% filter(term == "log(tot_bmr_prov)")
dn_formal_ols_prov_coef_s <- do.call(rbind, dn_formal_ols_prov_coef_s) %>% filter(term == "log(tot_bmr_prov)")
...
dn_formal_fe_coef_prov <- do.call(rbind, dn_formal_fe_coef_prov) %>% filter(term == "log(tot_bmr_prov)")
...
dn_formal_fe_prov_coef_n <- do.call(rbind, dn_formal_fe_prov_coef_n) %>% filter(term == "log(tot_bmr_prov)")
dn_formal_fe_prov_coef_s <- do.call(rbind, dn_formal_fe_prov_coef_s) %>% filter(term == "log(tot_bmr_prov)")
