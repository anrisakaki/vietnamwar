...
dn_indfe_prov_n <- (list(
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sex_ratio + log(popdensity_02) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn02, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sex_ratio + log(popdensity_03) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn03, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio05 + log(popdensity_04) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn04, south == 0),
        vcov = ~tinh), 
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio05 + log(popdensity_05) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn05, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio05 + log(popdensity_06) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn06, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio07 + log(popdensity_07) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn07, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio08 + log(popdensity_08) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn08, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio09 + log(popdensity_09) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn09, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio10 + log(popdensity_10) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn10, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio11 + log(popdensity_11) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn11, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio12 + log(popdensity_12) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn12, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio13 + log(popdensity_13) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn13, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio14 + log(popdensity_14) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn14, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio15 + log(popdensity_15) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn15, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio16 + log(popdensity_16) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn16, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio17 + log(popdensity_17) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn17, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sexratio18 + log(popdensity_18) + dist_nearest_base_prov + dist_nearest_hochi_prov | nganh_kd + lhdn,
        subset(dn18, south == 0),
        vcov = ~tinh)))
