...
dn_ols_coef_prov_ppn <- lapply(dn_ols_prov_ppn, tidy)
dn_ols_coef_prov_ppn <- do.call(rbind, dn_ols_coef_prov_ppn) %>% filter(term == "log(tot_bmr_prov_ppn)")
dn_ols_coef_prov_ppn$year <- rep(seq(2001, 2018), each = nrow(dn_ols_coef_prov_ppn) / length(seq(2001, 2018)))

## By south 
dn_ols_prov_ppn_n <- (list(
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sex_ratio | lhdn,
        subset(dn01, south == 0),
        vcov = ~tinh),
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn) + sex_ratio | lhdn,
...
dn_ols_prov_ppn_coef_n <- lapply(dn_ols_prov_ppn_n, tidy)
dn_ols_prov_ppn_coef_s <- lapply(dn_ols_prov_ppn_s, tidy)
dn_ols_prov_ppn_coef_n <- do.call(rbind, dn_ols_prov_ppn_coef_n) %>% filter(term == "log(tot_bmr_prov_ppn)")
dn_ols_prov_ppn_coef_s <- do.call(rbind, dn_ols_prov_ppn_coef_s) %>% filter(term == "log(tot_bmr_prov_ppn)")
dn_ols_prov_ppn_coef_n$year <- rep(seq(2001, 2018), each = nrow(dn_ols_prov_ppn_coef_n) / length(seq(2001, 2018)))
dn_ols_prov_ppn_coef_s$year <- rep(seq(2001, 2018), each = nrow(dn_ols_prov_ppn_coef_s) / length(seq(2001, 2018)))

dn_ols_prov_ppn_coef_n$group <- "North"
dn_ols_prov_ppn_coef_s$group <- "South"
dn_ols_prov_ppn_coef_ns <- rbind(dn_ols_prov_ppn_coef_n, dn_ols_prov_ppn_coef_s)
...
dn_formal_fe_coef_prov <- do.call(rbind, dn_formal_fe_coef_prov) %>% filter(term == "log(tot_bmr_prov_ppn)")
...
dn_formal_fe_prov_coef_n <- do.call(rbind, dn_formal_fe_prov_coef_n) %>% filter(term == "log(tot_bmr_prov_ppn)")
dn_formal_fe_prov_coef_s <- do.call(rbind, dn_formal_fe_prov_coef_s) %>% filter(term == "log(tot_bmr_prov_ppn)")
...
dn_prov_ols_s <- list(
  feols(tot_workerratio ~ log(tot_bmr_prov_ppn),
